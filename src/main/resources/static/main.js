...
module.exports = "<app-mobile-menu *ngIf=\"mobileVisibility\"></app-mobile-menu>\r\n<div class=\"flex-container-props\">\r\n    <app-menu *ngIf=\"desktopVisibility\"></app-menu>\r\n    <div class=\"container-fluid\">\r\n        <div class=\"row\">\r\n            <app-header *ngIf=\"desktopVisibility\"></app-header>\r\n            <!-- <app-test></app-test> -->\r\n        </div>\r\n        <div class=\"row\">\r\n            <div class=\"col-md-12 px-0\">\r\n                <ngx-spinner bdColor=\"rgba(192,192,192,0.8)\" size=\"large\" color=\"#fff\" type=\"ball-scale-multiple\">\r\n                    <p style=\"font-size: 20px; color: white\">Loading...</p>\r\n                </ngx-spinner>\r\n                <router-outlet></router-outlet>\r\n            </div>\r\n        </div>\r\n    </div>\r\n</div>"
...
module.exports = "<div class=\"container base-about-us\">\r\n  <div class=\"row mt-5\">\r\n    <div class=\"col-md-6\">\r\n      <app-image-panel [path]=\"'../../../../assets/image/mechanik.jpg'\" [width]='100' [height]='100'></app-image-panel>\r\n    </div>\r\n    <div class=\"col-md-6\">\r\n      <h4>O nas</h4>\r\n      <span>\r\n        <p> Mechanik i Przyjaciele - grupa powstała na początku grudnia 2017 roku. Pomysłodawcami byli Maciej Bielacha\r\n          oraz Sebastian Łukasiewicz (aktualnie inna grupa).\r\n          Oficjalnymi pierwszymi zawodami był 38 Międzynarodowy Bieg Sylwestrowy 2017.\r\n          Nazwa grupy powstała od kontynuacji szkoły średniej Mechanik w Kielcach tzn absolwentów tej szkoły oraz ich\r\n          kolegów.\r\n          W grupie jest już ponad 20 osób aktywnie spędzających czas m.in.: bieganie, triatlon, nordic walking. </p>\r\n        <p>\r\n          Najlepsza grupa biegowa w klasyfikacji drużynowej w: </p>\r\n        <ul>\r\n          <li> Liga biegowa CrossRun 2018, 2019,</li>\r\n          <li> II Impresje biegowe w Łopusznie 2019,</li>\r\n          <li> Strawczyńska Zadycha 2019,</li>\r\n        </ul>\r\n        <p>\r\n          Nasi zawodnicy bardzo często zajmują miejsca na podium\r\n        </p>\r\n        <p>\r\n          <strong>Zapraszamy kolejnych nowych biegaczy....</strong>\r\n        </p>\r\n      </span>\r\n    </div>\r\n  </div>\r\n</div>"
...
module.exports = "@font-face {\n  font-family: Roboto;\n  src: url(https://fonts.googleapis.com/css?family=Roboto); }\n\n/* Colors */\n\n/* Information dailog */\n\n/* Font Weight */\n\n/* Font Control Color */\n\n/* Notification Color Configuration\r\n        fc-font color, bg-background color, br- border color */\n\n/* Table Grid Styles\r\n        1.) Table Options */\n\n/* Side Nav Menu */\n\n:host #left-navbar-logo {\n  width: 100%;\n  height: 150px;\n  background: #faf9fe;\n  box-shadow: 0 2px 4px 0 #d3d3d3; }\n\n:host #left-navbar-logo span {\n    background: url(/assets/img/OnFinance_logo_white.png) no-repeat;\n    background-size: 70%;\n    background-position: center center;\n    width: 100%;\n    height: 100%;\n    display: block; }\n\n:host .navbar,\n:host .navbar-fixed-left {\n  display: -webkit-box;\n  display: flex;\n  width: 100%;\n  position: relative;\n  border-radius: 0;\n  -webkit-box-orient: vertical;\n  -webkit-box-direction: normal;\n          flex-direction: column;\n  -webkit-box-pack: start;\n          justify-content: flex-start;\n  padding: 0px; }\n\n:host .navbar h6,\n  :host .navbar-fixed-left h6 {\n    padding: 15px 16px;\n    font-size: 14px;\n    text-shadow: 0 2px 0 rgba(0, 0, 0, 0.05); }\n\n:host .navbar .nav-item,\n  :host .navbar-fixed-left .nav-item {\n    display: block;\n    position: relative;\n    padding: 15px 16px;\n    font-weight: 500;\n    font-size: 14px;\n    text-shadow: 0 2px 0 rgba(0, 0, 0, 0.05); }\n\n:host .navbar .nav-item.active,\n    :host .navbar-fixed-left .nav-item.active {\n      background-color: #e2e1e7; }\n\n:host .navbar .nav-item:hover, :host .navbar .nav-item:focus,\n    :host .navbar-fixed-left .nav-item:hover,\n    :host .navbar-fixed-left .nav-item:focus {\n      background-color: #e2e1e7; }\n\n:host .navbar .nav-item:hover span, :host .navbar .nav-item:focus span,\n      :host .navbar-fixed-left .nav-item:hover span,\n      :host .navbar-fixed-left .nav-item:focus span {\n        color: #30303f; }\n\n:host .navbar .nav-item:hover fa-icon,\n    :host .navbar-fixed-left .nav-item:hover fa-icon {\n      color: #30303f; }\n\n:host .navbar .nav-item fa-icon,\n    :host .navbar-fixed-left .nav-item fa-icon {\n      color: #30303f; }\n\n:host .navbar .nav-item span,\n    :host .navbar-fixed-left .nav-item span {\n      color: #30303f; }\n\n:host .navbar li.menu-item-icon-active-color,\n  :host .navbar-fixed-left li.menu-item-icon-active-color {\n    background-color: #e2e1e7; }\n\n:host .navbar li.menu-item-icon-active-color span,\n    :host .navbar-fixed-left li.menu-item-icon-active-color span {\n      color: #fff; }\n\n:host .navbar li.menu-item-icon-active-color a:after,\n    :host .navbar-fixed-left li.menu-item-icon-active-color a:after {\n      content: \"\";\n      position: absolute;\n      width: 0;\n      height: 0;\n      border-top: 12px solid transparent;\n      border-bottom: 12px solid transparent;\n      border-right: 10px solid #30303f;\n      bottom: 20px;\n      float: right;\n      right: 0px; }\n\n:host .navbar li.menu-item-icon-active-color a fa-icon,\n    :host .navbar-fixed-left li.menu-item-icon-active-color a fa-icon {\n      color: #30303f; }\n\n.base-set {\n  height: 100vh;\n  background-color: #faf9fe;\n  box-shadow: 0 2px 4px 0 #d3d3d3; }\n\n.position-base-set {\n  width: 100%;\n  background-color: #faf9fe; }\n\r\n/*# sourceMappingURL=data:application/json;base64, */"
...
/***/ "./src/app/shared/mobile-menu/mobile-menu.component.html":
/*!***************************************************************!*\
  !*** ./src/app/shared/mobile-menu/mobile-menu.component.html ***!
  \***************************************************************/
/*! no static exports found */
...
/***/ "./src/app/shared/mobile-menu/mobile-menu.component.scss":
/*!***************************************************************!*\
  !*** ./src/app/shared/mobile-menu/mobile-menu.component.scss ***!
  \***************************************************************/
/*! no static exports found */
...
/***/ "./src/app/shared/mobile-menu/mobile-menu.component.ts":
/*!*************************************************************!*\
  !*** ./src/app/shared/mobile-menu/mobile-menu.component.ts ***!
  \*************************************************************/
/*! exports provided: AppMobileMenuComponent */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "AppMobileMenuComponent", function() { return AppMobileMenuComponent; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");


var AppMobileMenuComponent = /** @class */ (function () {
    function AppMobileMenuComponent() {
        this.isCollapsed = true;
    }
    AppMobileMenuComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
            selector: 'app-mobile-menu',
            template: __webpack_require__(/*! ./mobile-menu.component.html */ "./src/app/shared/mobile-menu/mobile-menu.component.html"),
            styles: [__webpack_require__(/*! ./mobile-menu.component.scss */ "./src/app/shared/mobile-menu/mobile-menu.component.scss")]
        })
    ], AppMobileMenuComponent);
    return AppMobileMenuComponent;
}());
...
/* harmony import */ var _mobile_menu_mobile_menu_component__WEBPACK_IMPORTED_MODULE_36__ = __webpack_require__(/*! ./mobile-menu/mobile-menu.component */ "./src/app/shared/mobile-menu/mobile-menu.component.ts");
    ...
    SharedModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
            ...
            declarations: [_test_test_component__WEBPACK_IMPORTED_MODULE_6__["TestComponent"],
                ...
                _mobile_menu_mobile_menu_component__WEBPACK_IMPORTED_MODULE_36__["AppMobileMenuComponent"]],
